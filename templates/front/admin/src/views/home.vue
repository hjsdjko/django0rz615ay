...
<div class="content" :style='{"minHeight":"100vh","padding":"20px 20px 30px","alignItems":"flex-start","flexWrap":"wrap","background":"url(http://codegen.caihongy.cn/20230805/a0d58222f2a44e148bf030fbb779c936.png) no-repeat center top / cover","display":"flex","fontSize":"16px","height":"100%"}'>
	...
	<div :style='{"padding":"10px 10px 0","boxShadow":"0 1px 3px 0px rgba(115,108,203,.23)","margin":"0 30px 30px 30px","borderColor":"#fceaee","alignItems":"center","color":"#666","display":"flex","justifyContent":"center","borderRadius":"3px","flexWrap":"wrap","background":"#fff","borderWidth":"0px","width":"300px","fontSize":"14px","borderStyle":"double","order":"2"}'>
		<div :style='{"boxShadow":"0 0px 0px rgba(0,0,0,.3)","padding":"0 10px 0 0","margin":"0 0px 10px 0","borderColor":"#f0f0f0","borderRadius":"3px","textAlign":"center","background":"rgba(255, 255, 255,0)","borderWidth":"1px","display":"flex","width":"100%","borderStyle":"solid","justifyContent":"center"}' v-if="isAuth('dianyingxinxi','首页总数')">
			...
			<div :style='{"width":"auto","flexDirection":"column","justifyContent":"center","display":"flex"}'>
				<div :style='{"margin":"5px 0","lineHeight":"24px","fontSize":"24px","color":"inherit","fontWeight":"bold","height":"24px"}'>{{dianyingxinxiCount}}</div>
				<div :style='{"margin":"5px 0","lineHeight":"24px","fontSize":"inherit","color":"inherit","height":"24px"}'>电影信息总数</div>
			</div>
		</div>
	</div>
	<!-- statis -->
	...
	<div class="type5" :style='{"alignContent":"flex-start","padding":"0","borderRadius":"8px","flexWrap":"wrap","background":"none","flex":"1","display":"flex","width":"100%","position":"relative","justifyContent":"space-between","height":"auto","order":"3"}'>
		<div id="dianyingxinxiChart1" class="echarts1" v-if="isAuth('dianyingxinxi','首页统计')"></div>
		<div id="dianyingxinxiChart2" class="echarts2" v-if="isAuth('dianyingxinxi','首页统计')"></div>
		<div id="dianyingxinxiChart3" class="echarts3" v-if="isAuth('dianyingxinxi','首页统计')"></div>
		<div id="dianyingxinxiChart4" class="echarts4" v-if="isAuth('dianyingxinxi','首页统计')"></div>
		<div id="dianyingxinxiChart5" class="echarts5" v-if="isAuth('dianyingxinxi','首页统计')"></div>
	</div>
</div>
</template>
<script>
...
export default {
	...
	methods:{
        ...
        this.$http({
			url: "group/dianyingxinxi/moviename",
            method: "get",
        }).then(({ data }) => {
            if (data && data.code === 0) {
                let res = data.data;
                ...
                var option = {};
				this.wordclouds(pArray,'dianyingxinxiChart1');
