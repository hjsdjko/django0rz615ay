			...
			<div :style='{"width":"28%","padding":"30px 10px 0 0","flexWrap":"wrap","display":"flex"}'>
				<div class="echarts1">
					...
					<div :style='{"width":"100%","height":"85%","zIndex":"9"}'>
						<div id="dianyingxinxiChart1" style="width:100%;height:100%;"></div>
					</div>
				</div>
				<div class="echarts2">
					<div :style='{"width":"100%","padding":"0 0 0 60px","margin":"0 0 10px","textAlign":"left","background":"url(http://codegen.caihongy.cn/20231222/6b6d1211d4614868b2253cd91924db42.png) no-repeat center top /100% 100%","height":"42px"}'>
					...
					<div :style='{"width":"100%","height":"85%","zIndex":"9"}'>
						<div id="dianyingxinxiChart2" style="width:100%;height:100%;"></div>
					</div>
				</div>
				<div class="echarts3">
					<div :style='{"width":"100%","padding":"0 0 0 60px","margin":"0 0 10px","textAlign":"left","background":"url(http://codegen.caihongy.cn/20231222/6b6d1211d4614868b2253cd91924db42.png) no-repeat center top /100% 100%","height":"42px"}'>
					...
					<div :style='{"width":"100%","height":"85%","zIndex":"9"}'>
						<div id="dianyingxinxiChart3" style="width:100%;height:100%;"></div>
					</div>
				</div>
			</div>
				...
				<div :style='{"alignContent":"flex-start","padding":"0px","margin":"0 0 20px","color":"#fff","flexWrap":"wrap","background":"none","display":"flex","width":"100%","fontSize":"14px","justifyContent":"center","height":"calc(32% - 40px)","order":"2"}'>
					...
					<div :style='{"margin":"0 20px 0 0 ","alignItems":"center","borderRadius":"100%","background":"rgba(255,255,255,.2)","flexDirection":"column","display":"flex","width":"130px","position":"relative","justifyContent":"center","height":"130px"}'>
						...
						<div :style='{"padding":"0","margin":"20px 0 0","alignItems":"center","textAlign":"center","flexDirection":"column","display":"block","justifyContent":"space-between"}'>
							<div :style='{"lineHeight":"auto","fontSize":"inherit","color":"inherit","height":"auto"}'>电影信息总数</div>
							<div :style='{"lineHeight":"40px","fontSize":"16px","color":"#fff","fontWeight":"bold","height":"auto"}'>{{dianyingxinxiCount}}</div>
						</div>
					</div>
				</div>
				<div class="tables">
					<div :style='{"padding":"0 0 0 60px","margin":"0 0 20px 0","color":"#fff","textAlign":"left","background":"url(http://codegen.caihongy.cn/20231222/6b6d1211d4614868b2253cd91924db42.png) no-repeat center top /100% 100%","width":"100%","lineHeight":"42px","fontSize":"16px","height":"42px"}'>电影信息</div>
					<el-table :data="boardDataList" border :stripe="false" :style='{"padding":"0","borderColor":"#044bbe","borderWidth":"1px 0 0 1px","background":"none","width":"100%","borderStyle":"solid","zIndex":"9"}'>
						<el-table-column :resizable="true" :sortable="false" prop="moviename" label="电影名称"/>
						</el-table-column>
						<el-table-column :resizable="true" :sortable="false" prop="score" label="评分"/>
						</el-table-column>
						<el-table-column :resizable="true" :sortable="false" prop="daoyan" label="导演"/>
						</el-table-column>
						<el-table-column :resizable="true" :sortable="false" prop="leixing" label="类型"/>
						</el-table-column>
						<el-table-column :resizable="true" :sortable="false" prop="diqu" label="地区"/>
						</el-table-column>
						<el-table-column :resizable="true" :sortable="false" prop="zhuyan" label="主演"/>
						</el-table-column>
					</el-table>
				</div>
			</div>
      ...
      this.$nextTick(()=>{
        ...
        this.$http({
            ...
            if (data && data.code === 0) {
				...
				this.myChartInterval(2, option.yAxis.data, option.series[0].data, dianyingxinxiChart4)
      ...
      this.$nextTick(()=>{
        ...
        this.$http({
            ...
            if (data && data.code === 0) {
				...
				this.myChartInterval(1, option.xAxis.data, option.series[0].data, dianyingxinxiChart5)
