...
def schemaName_spider(request, tableName):
    if request.method in ["POST", "GET"]:
        ...
        # Linux
        cmd = "cd /yykj/python/9999/spider4xa7371a && scrapy crawl "+tableName+"Spider -a databaseName=django0rz615ay"
        # Windows
        # cmd = "cd C:\\test1\\spider && scrapy crawl " + tableName + "Spider -a databaseName=django0rz615ay"
        os.system(cmd)
